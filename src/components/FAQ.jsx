...
export default function FAQ() {
  ...
  return (
    <section id="duvidas" className="combined-duvidas reveal-on-scroll">
      <div className="duvidas-band duvidas-band-intro">
      ...
      <div className="duvidas-band duvidas-band-faq">
